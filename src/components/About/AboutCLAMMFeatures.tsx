...
export default function AboutCLAMMFeatures() {
  return (
        ...
        <div className="flex flex-col items-center gap-6">
          <div className="w-full max-w-xl bg-gray-900/80  p-6 rounded-xl">
            <div className="flex items-start gap-4 ">
              ...
              <p className="text-gray-200 leading-relaxed">Dashboard</p>
            </div>
          </div>
          ...
          <div className="w-full max-w-xl bg-gray-900/80 p-6 rounded-xl">
            <div className="flex items-start gap-4  ">
              ...
              <p className="text-gray-200 leading-relaxed">Real-time updates</p>
            </div>
          </div>
        </div>
      </div>
